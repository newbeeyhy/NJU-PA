...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_i2a_b, add_i2a_v, push_es, pop_es,
    ...
    /* 0x14 - 0x17*/ adc_i2a_b, adc_i2a_v, push_ss, pop_ss,
    /* 0x18 - 0x1b*/ sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
    /* 0x1c - 0x1f*/ sbb_i2a_b, sbb_i2a_v, push_ds, pop_ds,
    ...
    /* 0xe8 - 0xeb*/ call_instr_direct, jmp_near, inv, jmp_short,
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0xa0 - 0xa3*/ push_fs, pop_fs, inv, bt_r2rm_v,
    /* 0xa4 - 0xa7*/ inv, inv, inv, inv,
    /* 0xa8 - 0xab*/ push_gs, pop_gs, inv, inv,
